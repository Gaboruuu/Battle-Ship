from src.board.computer_board import ComputerBoard
from src.board.player_board import PlayerBoard
...
class Game:
    def __init__(self, player_board: PlayerBoard, computer_board: ComputerBoard, battleships: int, battle_ship_length: list):
        ...
        self._player_board.place_battleships(battleships, battle_ship_length)
        self._computer_board.place_battleships(battleships, battle_ship_length)
